...
# We will denote closing price for a Netflix stock on given day, "i", the initial day
#    as P_i, and P_i-1 refers to the closing price for a Netflix stock for day before P_i.

# "Rates of Return", R_i, is defined as:
#    R_i = (P_i - P_i-1)/(P_i-1)
